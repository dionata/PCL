...
namespace NLinear
{
    public class Hull
    {
        ...
        public Vector3<double> Center;
        public List<VertexHull> Vertices;
        public List<Edge> Edges;

        public Hull(Box myBox, Vector3<double> myCenter)
        {
            this.Center = new Vector3<double>(myCenter);
        ...
        //private void AddEdges(Plane3<double> myPlane)
        //{
