...
namespace PCLLib
{
    ...
    public class cChain
    {
        ...
        private double[] linklen = new double[1000];
        private double[] linklenback = new double[1000];

        //private cVertex newpoint, c, q;

        public cVertex v1, v2;

        double L1, L2, L3;		//Length of links between kinks
        double totLength;		//total Length of all links
