...
namespace PCLLib
{
    ...
    public class cVertexList
    {
        ...
        public void ResetVertex(cVertex resV, double x, double y, int vnum, bool mark)
        {
            resV.Point.X = x;
            resV.Point.Y = y;
         ...
         */
        public cVertex GetNearVertex(double x, double y)
        {
         ...
         */
        public cVertex FindVertex(double x, double y, double w, double h)
        {
        ...
        {
            cVertex temp = head;
            System.Diagnostics.Debug.WriteLine("Printing vertices...");
            if (head != null)
            {
                do
                {
