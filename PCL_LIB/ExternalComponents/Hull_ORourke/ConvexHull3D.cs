...
namespace PCLLib
{
    ...
    public class ConvexHull3D
    {
        ...
        /*---------------------------------------------------------------------
          ...
          ---------------------------------------------------------------------*/
        protected void SubVec(double[] a, double[] b, double[] c)
        {
            int i;
        ...
        /*---------------------------------------------------------------------*/
        protected double Volumei(cFace f, cVertex p)
        {
            double vol;
            double ax, ay, az, bx, by, bz, cx, cy, cz, dx, dy, dz;
            double bxdx, bydy, bzdz, cxdx, cydy, czdz;
        ...
        /*---------------------------------------------------------------------
          ...
          ---------------------------------------------------------------------*/
        protected double Volumed(cFace f, cVertex p)
        {
            double vol;
            double ax, ay, az, bx, by, bz, cx, cy, cz, dx, dy, dz;
            double bxdx, bydy, bzdz, cxdx, cydy, czdz;
        ...
        /*---------------------------------------------------------------------
          ...
          ---------------------------------------------------------------------*/
        protected double Normz(cFace f)
        {
            cVertex a, b, c;
