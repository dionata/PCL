...
namespace KDTreeRednaxela
{
    ...
    public class IntervalHeap<T>
    {
        ...
        public void Insert(double key, T value, int index)
        {
        ...
        public void ReplaceMin(double key, T value, int index)
        {
            // Check for errors.
            if (Size == 0)
                throw new Exception();
        ...
        public void ReplaceMax(double key, T value, int index)
        {
            if (Size == 0)
            {
                throw new Exception();
        ...
        private void SiftDownMin(int iParent)
        {
            ...
            {
                // If the gcode child is less than the current child, select the gcode one.
